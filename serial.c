...
void startSerial(const char *portName, int baudRate, int byteSize, char parity,
                 int stopBits, int maxAttempts)
{
    _fd = -1;
    ...
    switch (byteSize) {
        case 5:  _serOptions.c_cflag |= CS5; break;
        case 6:  _serOptions.c_cflag |= CS6; break;
        case 7:  _serOptions.c_cflag |= CS7; break;
        default: _serOptions.c_cflag |= CS8; break;
    }
    ...
    /* Raw output: cfmakeraw() already clears OPOST; mask again for safety. */
